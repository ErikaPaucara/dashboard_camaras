...
def layout():
    ...
    fig_general.update_layout(
        title="ESTADO GENERAL DE CABINAS",
        height=400
    )
    ...
    fig_barras.update_layout(
        title="ESTADO DE CABINAS POR LÍNEA",
        barmode='group',
        height=400,
        xaxis_title="Líneas",
    ...
    return html.Div([
        ...
        dcc.Download(id="download-pdf-Cabinas"),
        html.H1(
            "CABINAS MI TELEFERICO",
            style={
                "textAlign": "center",
                "marginBottom": "30px",
                "fontWeight": "bold"
...
@callback(
    Output("download-pdf-Cabinas", "data"),
    Input("btn-pdf-Cabinas", "n_clicks"),
