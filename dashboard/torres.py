...
def layout():
    ...
    fig_general.update_layout(
        title="ESTADO GENERAL DE TORRES",
        height=400
    )
    ...
    fig_barras.update_layout(
        title="ESTADO DE TORRES POR LÍNEA",
        barmode='group',
        height=400,
        xaxis_title="Líneas",
    ...
    return html.Div([
        ...
        dcc.Download(id="download-pdf-Torres"),
        html.H1(
            "TORRES MI TELEFERICO",
            style={
                "textAlign": "center",
                "marginBottom": "30px",
                "fontWeight": "bold"
...
@callback(
    Output("download-pdf-Torres", "data"),
    Input("btn-pdf-Torres", "n_clicks"),
